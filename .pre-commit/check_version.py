...
def validate_version():
    ...
    Check version number in setup.json and aiida_gulp/__init__.py and make sure
    they match.
    """
    # Get version from python package
    sys.path.insert(0, ROOT_DIR)
    import aiida_gulp  # pylint: disable=wrong-import-position

    version = aiida_gulp.__version__
    ...
    if version != setup_content["version"]:
        ...
        click.echo(
            "Version number in '{}/__init__.py': {}".format("aiida_gulp", version)
        )
        click.echo(
