# -*- coding: utf-8 -*-
#
# Sphinx configuration for aiida-gulp
#
...
try:
    ...
    git_commit = "v{}".format(aiida_gulp.__version__)
...
.. only:: html
    ...
    __ https://github.com/chrisjsewell/aiida-gulp/blob/{git_commit}/{{{{ docname }}}}
...
if six.PY2:
    ...
    intersphinx_aliases[("py:class", "callable")] = (
        "py:class",
...
release = aiida_gulp.__version__
...
def run_apidoc(_):
    ...
    package_dir = os.path.join(source_dir, os.pardir, os.pardir, "aiida_gulp")
    exclude_paths = [
        os.path.join(source_dir, os.pardir, os.pardir, "aiida_gulp", "tests", "test_*"),
        os.path.join(
            source_dir, os.pardir, os.pardir, "aiida_gulp", "tests", "raw_files"
        ),
    ]
    ...
    options = ["--private", "--force", "--no-toc", "-o", apidoc_dir, package_dir]
...
html_use_opensearch = "http://aiida-gulp.readthedocs.io"
...
htmlhelp_basename = "aiida-gulp-doc"
