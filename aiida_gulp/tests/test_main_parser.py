...
def test_parse_failed():
    ...
    expected = {'parser_errors': ["expected 'initial' data"],
...
def test_parse_opt_reaxff_pyrite():
    ...
    expected = {'parser_errors': [],
                'parser_version': __version__,
                'errors': [],
                'energy_contributions': {'Double-Bond Valence Angle Penalty': 0.0, 'Charge Equilibration': -0.26861672,
                                         'Coulomb': -3.09567064, 'Coordination (over)': 9.9335806, 'Conjugation': 0.0,
                                         'Valence Angle': 14.85816318, 'Hydrogen Bond': 0.0,
                                         'Valence Angle Conjugation': 0.0, 'Coordination (under)': 1.1e-07,
                                         'Torsion': 0.79757591, 'Lone-Pair': 1.21245733, 'van der Waals': 3.23561148,
                                         'Bond': -70.24055778},
                'optimised': True,
                'warnings': [],
                'energy_units': 'eV',
