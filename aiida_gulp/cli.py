# -*- coding: utf-8 -*-
"""
Command line interface (cli) for aiida_gulp.
...
def submit(codelabel, submit):
    ...
    Run ``gulp-submit --help`` to see options.
    """
    ...
    DiffParameters = DataFactory('gulp')
    ...
    # set up calculation
    calc = code.new_calc()
    calc.label = "aiida_gulp test"
    calc.description = "Test job submission with the aiida_gulp plugin"
