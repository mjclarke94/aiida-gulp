...
class GulpAbstractCalculation(CalcJob):
    ...
    def define(cls, spec):
        ...
        spec.input(
            ...
            required=True,
            help=(
                "atomic structure used to create the "
        ...
        spec.input(
            ...
            required=False,
            help=("additional input parameters " "to create the .gin file content."),
        )
        ...
        spec.exit_code(
            ...
            message=(
                "An error was flagged trying to parse the " "main gulp output file"
            ),
        )
