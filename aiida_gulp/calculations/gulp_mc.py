...
from aiida_gulp.parsers.raw.write_input import InputCreationMC


class GulpMCCalculation(GulpAbstractCalculation):
    """
    ...
    def define(cls, spec):
        ...
        super(GulpMCCalculation, cls).define(spec)
        ...
        spec.output(
            ...
            required=True,
            help="Final structure from Monte Carlo simulation.",
        )

    def create_input(self, structure, potential, parameters=None, symmetry=None):
        input_creation = InputCreationMC(
